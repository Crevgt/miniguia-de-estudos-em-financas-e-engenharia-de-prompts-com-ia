...
Por limitações de hardware e questão de desempenho, foi utilizada uma amostra de 50.000 registros para o treinamento, em vez de utilizar todos os registros disponíveis no conjunto de treinamento.
